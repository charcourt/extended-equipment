...
data:extend{
  {
    ...
    icons = util.technology_icon_constant_equipment(mod_gfx "technology/battery-mk3-equipment.png"),
	  icon_size = 128,
    icon_mipmaps = 4,
    prerequisites = {"battery-mk2-equipment", "space-science-pack", "effectivity-module"},
    effects =
    {
      {
        type = "unlock-recipe",
  ...
  },
  {
    ...
    icons = util.technology_icon_constant_equipment(mod_gfx "technology/energy-shield-mk3-equipment.png"),
	  icon_size = 128,
    icon_mipmaps = 4,
    prerequisites = {"energy-shield-mk2-equipment", "military-4", "effectivity-module", "space-science-pack"},
    effects =
    {
      {
        type = "unlock-recipe",
  ...
  },
  {
    ...
    prerequisites = {"exoskeleton-equipment", "space-science-pack", "speed-module"},
    effects =
    {
      {
        type = "unlock-recipe",
  ...
  },
  {
    ...
    icons = util.technology_icon_constant_equipment(mod_gfx "technology/fusion-reactor-mk2-equipment.png"),
	  icon_size = 256, icon_mipmaps = 4,
    prerequisites = {"fusion-reactor-equipment", "space-science-pack", "effectivity-module-3"},
    effects =
    {
      {
        type = "unlock-recipe",
  ...
  },
  {
    ...
    icon_size = 256,
    icon_mipmaps = 4,
    prerequisites = {"personal-roboport-mk2-equipment", "space-science-pack", "effectivity-module"},
    effects =
    {
      {
        type = "unlock-recipe",
  ...
  },
  {
    ...
    icon_size = 256, icon_mipmaps = 4,
    prerequisites = {"power-armor-mk2", "speed-module-3", "space-science-pack", "effectivity-module-3"},
    effects =
    {
      {
        type = "unlock-recipe",
